...
const val dummyFilteredLocationResult = "[UserLocation(latitude=53.2451022, userId=4, name=Ian Kehoe, longitude=-6.238335), UserLocation(latitude=53.1302756, userId=5, name=Nora Dempsey, longitude=-6.2397222), UserLocation(latitude=53.1229599, userId=6, name=Theresa Enright, longitude=-6.2705202), UserLocation(latitude=54.0894797, userId=8, name=Eoin Ahearn, longitude=-6.18671), UserLocation(latitude=53.008769, userId=11, name=Richard Finnegan, longitude=-6.1056711), UserLocation(latitude=52.986375, userId=12, name=Christina McArdle, longitude=-6.043701), UserLocation(latitude=53.0, userId=13, name=Olive Ahearn, longitude=-7.0), UserLocation(latitude=52.966, userId=15, name=Michael Ahearn, longitude=-6.463), UserLocation(latitude=54.180238, userId=17, name=Patricia Cahill, longitude=-5.920898), UserLocation(latitude=54.080556, userId=23, name=Eoin Gallagher, longitude=-6.361944), UserLocation(latitude=54.133333, userId=24, name=Rose Enright, longitude=-6.433333), UserLocation(latitude=53.038056, userId=26, name=Stephen McArdle, longitude=-7.653889), UserLocation(latitude=53.74452, userId=29, name=Oliver Ahearn, longitude=-7.11167), UserLocation(latitude=53.761389, userId=30, name=Nick Enright, longitude=-7.2875), UserLocation(latitude=53.1489345, userId=31, name=Alan Behan, longitude=-6.8422408), UserLocation(latitude=53.0033946, userId=39, name=Lisa Ahearn, longitude=-6.3877505)]"
